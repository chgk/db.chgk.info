 ...
 */
//CHGK: deleted 
function zeropoint_preprocess_search_result_(&$variables) {
...
###CHGK###
function zeropoint_date_select($element) {
  $class = 'container-inline-date';
  if (isset($element['#children'])) {
    $output = $element['#children'];
  }
  return '<div style="width:200px" class="'. $class .'">'. theme('form_element', $element, $output) .'</div>';
}
