...
Drupal.behaviors.color = function (context) {
  ...
  if ($('#swftools_flowplayer3_scheme_form .color-form.color-processed').size()) {
    return;
  }
  var form = $('#swftools_flowplayer3_scheme_form .color-form', context);
  var inputs = [];
  var hooks = [];
  var locks = [];
  var focused = null;
  ...
  $('#edit-swftools-flowplayer3-scheme', form).change(function () {
...
//      }
  ...
  function resetScheme() {
    $('#edit-swftools-flowplayer3-scheme', form).each(function () {
